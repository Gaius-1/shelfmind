...
export const initialEdges: Edge[] = [
  { id: 'e1', source: 'upload', target: 'zxing', animated: false, type: 'smoothstep', style: { strokeWidth: 2 } },
  { id: 'e2', source: 'upload', target: 'ocr', animated: false, type: 'smoothstep', style: { strokeWidth: 2 } },
  { id: 'e3', source: 'upload', target: 'structured', animated: false, type: 'smoothstep', style: { strokeWidth: 2 } },
  
  { id: 'e4', source: 'zxing', target: 'grouping', animated: false, type: 'smoothstep', style: { strokeWidth: 2 } },
