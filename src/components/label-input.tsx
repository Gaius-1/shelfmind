...
export function LabelInput({
  ...
  return (
    <div className={cn("group relative w-full", className, containerClassName)}>
      <input
        className={cn(
          "block outline-none peer w-full px-3.5 h-10 text-sm rounded-lg border focus:ring-2 placeholder-transparent transition-all duration-300",
          isDark 
            ? "text-neutral-50 bg-white/5 border-white/10 autofill:shadow-[inset_0_0_0px_1000px_rgb(23,23,23)]" 
            : "text-neutral-900 bg-neutral-50 border-neutral-200 autofill:shadow-[inset_0_0_0px_1000px_rgb(250,250,250)]",
          isPasswordType && "pr-9",
      ...
      />
      <label className={cn(
        "absolute block inset-y-0 px-2 text-sm left-[7px] h-fit text-nowrap my-auto -translate-y-[19px] peer-focus:-translate-y-[19px] pointer-events-none transition-all duration-200 scale-[.8] origin-top-left peer-placeholder-shown:scale-100 peer-focus:scale-[.8] peer-placeholder-shown:translate-y-0",
        isDark 
