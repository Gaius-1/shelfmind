...
import { ImageIcon, Video02Icon, HeadphonesIcon, File02Icon, GoogleSheetIcon, ArchiveIcon, Upload01Icon, CloudUploadIcon, Delete02Icon, Download01Icon, Refresh04Icon, AlertCircleIcon } from "@hugeicons/core-free-icons"
    ...
    <div className={cn("w-full space-y-4", className)}>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          >
            <HugeiconsIcon icon={Upload01Icon} strokeWidth={2} className="text-muted-foreground h-5 w-5" />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <Button onClick={openFileDialog} variant="outline" size="sm">
                <HugeiconsIcon icon={CloudUploadIcon} strokeWidth={2} className="h-4 w-4" />
                Add files
              </Button>
