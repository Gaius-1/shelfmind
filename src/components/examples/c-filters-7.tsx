...
} from "#/components/reui/filters.tsx"
import {
  ColumnDef,
  getCoreRowModel,
  getFilteredRowModel,
...
import { UserIcon, MailIcon, Building02Icon, Location06Icon, FilterMailIcon, FilterRemoveIcon, AlertCircleIcon } from "@hugeicons/core-free-icons"
...
export function Pattern() {
  ...
  const fields: FilterFieldConfig[] = [
    ...
    },
    {
      ...
      label: "Company",
      icon: (
        <HugeiconsIcon icon={Building02Icon} strokeWidth={2} className="size-3.5" />
      ),
      type: "select",
      searchable: true,
      className: "w-[180px]",
    ...
    },
    {
      ...
      label: "Location",
      icon: (
        <HugeiconsIcon icon={Location06Icon} strokeWidth={2} className="size-3.5" />
      ),
      type: "text",
      className: "w-40",
